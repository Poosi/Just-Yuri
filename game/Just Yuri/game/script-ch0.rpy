label ch0_main:
    ...
    "You already know today is going to be a boring Wednesday."
    "On top of that, you've already been having a pretty bad day. You even burnt your toast for gods sakes..."
    "As you walk down the street towards school, you realize you were supposed to wait for your neighbor, Sayori."
    "But, you were already getting pretty close and it would be silly to stop for her now."
    "However, as you begin to cross the street, you trip on the curb and fall into a pile of glass shards."
    mc "GAH!"
    $ y_name = "Yuri"
    mc "Ah, SHIT!"
    "You really ought to be more careful when you're walking..."
    mc "OW OW OW!"
    y "Oh! What happened...?"
    "A purple haired girl is standing over you as you're making a fool of yourself."
    "This day keeps getting worse, huh?"
    y "That looks bad, please do hold still..."
    "The girl pulls a cream out of her backpack and rubs some on your arm. She looks quite concerned."
    mc "That stings..!"
    show yuri at t11 zorder 2
    y 1a "Is that better?"
    "The realization that other classmates are looking at you across the street makes you realize how embarrassing this is..."
    y "How about I walk you to school..?"
    y 1f "-to make sure you get there alright, of course..."
    "Considering you have two long, bleeding cuts on your arm, you figure it may be best to walk with her so you don't keep making a fool of yourself."
    mc "Y-yeah, of course."
    y 1a "hehe~"
    ...
    y "By the way, your name is [player], right?"
    y "Please be more careful, and make sure you wash those cuts. You don't want them to be infected, do you?"
    "...Is this girl giving me a 'mom' lecture?"
    mc "Oh... Yeah. I never got your name."
    y 3h "Eh?"
    y 1a "Oh, my name is Yuri."
    "A small pang of nausea hits, and you groan a bit in discomfort."
    "You probably should hurry to the nurse's to get your arm patched up."
    y 3j "Oh- your arm!"
    "Yuri unknowingly grabs your cut-up arm in an attempt to get you to the nurses quicker."
    mc "Eh!"
    "Realizing she grabbed your injured arm and now has your blood all over her hand, she gasps in embassarassment."
    show yuri at t11
    y 3n "I-I'M sorry..!"
    hide yuri
    "And like that, she's gone."
    "Guess you're walking yourself to the nurse."

    scene bg class_day
    with wipeleft_scene

    "Thankfully, my day wasn't as bad as I thought it would be after this morning."
    "After I pack up my things, I stare blankly at the wall, bored out of my mind."
    mc "I could..."
    "Oh! Sayori had wanted to talk to me today!"
    "I guess I have to go look for her..."
    ...
    mc "You don't need to wait up for me if you've got plans."
    ...
    "Yuri, the girl who helped you this morning, seems to have a hard time keeping up with people like Sayori and Natsuki. Odd, she seemed more talkative this morning."
    show yuri at t33 zorder 2
    mc "Ah... Well, it's nice to meet you, Natsuki."
    show yuri at thide zorder 1
    show natsuki at thide zorder 1
    hide natsuki
    show sayori at f31 zorder 3
    s 1a "And it sounds like you already know Monika and Yuri, is that right?"
    $ m_name = 'Monika'
    show sayori at t31 zorder 2
    ...
    "Monika smiles sweetly, while Yuri glaces away a bit awkwardly."
    ...
    "Monika looks over at me once more, then leans in and whispers into my ear."
    m 1r "{i} [player], something's wrong. I can't talk about it right now, but we can later. {i}"
    ...
    show yuri 1 at t41 zorder 2
    "Yuri,"
    show yuri 4 at t42 zorder 2
    "Yuri,"

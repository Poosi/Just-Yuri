label yuri_exclusive_1:
    scene bg club_day
    with wipeleft_scene
    "I'm really curious to talk to Yuri a little bit more, especially with what happened yesterday."
    ...
    y "Ah, [player]... How is your arm today?"
    "After the weird incident yesterday morning, the nurse bandaged your arm up quite a bit."
    mc "I'm doing better, thanks to your help."
    "She blushes a bit, and looks away."
    y 4b "...I'm sorry for running off yesterday, and grabbing you like that..."
    "She hides her face deeper in her book."
    mc "Don't worry about it, it's my fault for even getting cut up like that..."
    y "Well, cuts are dangerous if left alone, I would know-"
    "Eh?"
    y 1i "Oh..."
    y "Umm... Never mind."
    "Something is weird about the way she said that, but you decide to change topics."
